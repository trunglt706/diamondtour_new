                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="item2-tab" data-bs-toggle="tab"
                                        ...
                                        <div class="box-item">
                                            <div class="icon-item">
                                                <div class="img">
                                                    <img src="/style/images/item/tructhang.png" alt="">
                                                </div>
                                            </div>
                                            <div class="title-box-item">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="item3-tab" data-bs-toggle="tab"
                                        ...
                                        <div class="box-item">
                                            <div class="icon-item">
                                                <div class="img">
                                                    <img src="/style/images/item/xehoi.png" alt="">
                                                </div>
                                            </div>
                                            <div class="title-box-item">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="item3-tab" data-bs-toggle="tab"
                                        ...
                                        <div class="box-item">
                                            <div class="icon-item">
                                                <div class="img">
                                                    <img src="/style/images/item/cuoingua.png" alt="">
                                                </div>
                                            </div>
                                            <div class="title-box-item">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="item3-tab" data-bs-toggle="tab"
                                        ...
                                        <div class="box-item">
                                            <div class="icon-item">
                                                <div class="img">
                                                    <img src="/style/images/item/ditau.png" alt="">
                                                </div>
                                            </div>
                                            <div class="title-box-item">
