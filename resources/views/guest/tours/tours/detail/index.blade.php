...
@section('style')
    ...
    <style>
        ...
        .widget_about_5 .box-content .description p {
                ...
                <div class="list-item">
                    <div class="row">
                        {{-- <div class="col-12 col-md-3 item">
                            <div class="top">
                                <img src="/style/images/icon/chat_bot_x2C__chatbot_x2C__chat_x2C__message_x2C__communication.png"
                                    alt="">
                                <p class="title">
                                    @lang('messages.tour.ngon_ngu')
                                </p>
                            </div>
                            <p class="description">
                                {{ $item->language ?? __('messages.dang_cap_nhat') }}
                            </p>
                        </div> --}}
                                ...
                                <div class="outer">
                                    <div class="content-head">
                                        <div class="item"><img src="/style/images/hoanhuy.png"
                                                alt="">@lang('messages.tour.hoan_huy_linh_hoat')</div>
                                        <div class="item"><img src="/style/images/antoan.png"
                                                alt="">@lang('messages.tour.safe_payment')</div>
                                    </div>
