                        ...
                        <div class="row-flex">
                            <div class="box-left col-12 col-md-3">
                                ...
                                <div class="list-item">
                                    <div class="item">
                                        <div class="img">
                                            <img src="/style/images/icon/Message.png" alt="" srcset="">
                                        </div>
                                        <a href="#">info@diamondtour.vn</a>
                                    </div>
                                    <div class="item">
                                        <div class="img">
                                            <img src="/style/images/icon/Call.png" alt="" srcset="">
                                        </div>
                                        <a href="#">0905 615 666 / 0388 116 636</a>
                                    </div>
                                    {{-- <div class="item">
                                        <div class="img">
                                            <img src="/style/images/icon/Home.png" alt="" srcset="">
                                        </div>
                                        <a href="/">497 Phố Cổ, Hà Nội</a>
                                    </div> --}}
                                    <a href="https://maps.app.goo.gl/vBS9WGybwZSQYngy8"
                            ...
                            <div class="box-right col-12 col-md-9">
                                <div class="swiper">
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="img swiper-slide">
                                            <img src="/style/images/post/poooo.png" alt="">
                                        </div>
                                        <div class="img swiper-slide">
                                            <img src="/style/images/post/v.png" alt="">
                                        </div>
                                    </div>
