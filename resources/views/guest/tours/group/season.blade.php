...
@section('title', __('messages.tour.list_tour_theo_mua'))
@section('keywords', '')
@section('description', __('messages.tour.list_tour_theo_mua'))
@section('image', '')
@section('content')
    <style>
        .widget_tour_1 {
            ...
            <div class="container">
                <div class="header-title header-title-style-3">
                    <p class="header text-center">
                        @php
                            $text_mua = 'messages.home.mua_' . $_GET['q'];
                        @endphp
                        @lang('messages.tour.list_tour_theo_mua') @lang($text_mua)
                    </p>
                </div>
                <div class="row">
