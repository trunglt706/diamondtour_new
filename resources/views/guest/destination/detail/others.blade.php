        ...
        <div class="container">
            ...
            <div class="row">
                @foreach ($data['others'] as $other)
                    @php
                        $_url = route('destination.detail', ['slug' => $other->slug]);
                    @endphp
                    <div class="col-12">
                        <div class="tour-item">
                            <div class="img">
                                <a href="{{ $_url }}">
                                    <img data-src="{{ get_file($other->image) }}" src="{{ asset('style/images/blogs/default.jpg') }}" alt="Image" loading="lazy" width="648px" height="293px">
                                </a>
                            </div>
                            <div class="title">
