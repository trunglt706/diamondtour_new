...
@section('style')
    ...
    <style>
        ...
        @media (max-width: 932px) {
            ...
            .email-register-form,
            .widget_email_style_1 form .input {
                width: 100%;
            }

            .box-left .widget_post_style_1.js_widget_post_style_1_9 .item .title {
                width: 100% !important;
                padding: 8px !important;
                left: 0px !important;
            }

            .box-left .widget_post_style_1.js_widget_post_style_1_9 .item .title .header a {
            ...
            .js_widget_post_style_1_8 .item .title .br {
