                    ...
                    <div id="section-blog-page--content" class="row gx-4 section-blog-page--content">
                        ...
                        <div class="blog-grid-item size-w-66 size-h-596">
                            <div class="blog-mansory--item"
                                style="background-image: url({{ asset('assets/images/blog-mansory-1.png') }});">
                                <div class="-content">
                                    {{-- <a href="#" class="-category">Category</a> --}}
                                    <h2><a href="#">Ut aliquet magna viverra tincidunt. Suspendisse et massa
                                            vulputate</a></h2>
                                    <p>Nullam pellentesque bibendum justo. In lobortis vestibulum justo. Aliquam
                                        pellentesque feugiat tortor sed pellentesque. Proin ornare urna quis aliquet auctor.
                                        Sed eu quam enim. Suspendisse potenti</p>
                                </div>
                            </div>
                        </div>
                        <div class="blog-grid-item size-w-33 size-h-282">
                            <div class="blog-mansory--item"
                                style="background-image: url({{ asset('assets/images/blog-mansory-2.png') }});">
                                <div class="-content">
                                    {{-- <a href="#" class="-category">Category</a> --}}
                        ...
                        <div class="blog-grid-item size-w-33 size-h-282">
                            <div class="blog-mansory--item"
                                style="background-image: url({{ asset('assets/images/blog-mansory-3.png') }});">
                                <div class="-content">
                                    {{-- <a href="#" class="-category">Category</a> --}}
