...
<div class="tab-content" id="nav-tabContent">
    <div class="tab-pane fade show active" id="nav-vi-update" role="tabpanel" aria-labelledby="nav-vi-tab-update"
        ...
        <div class="mb-1 form-group">
            ...
            <input type="text" placeholder="Tên dịch vụ" class="form-control" required value="{{ $data->name }}"
                name="name">
        </div>
        <div class="d-flex justify-content-between align-items-center my-3 d-none">
        ...
        <div class="mb-1 form-group">
            ...
            <input type="file" class="form-control" name="backgrounds[]" multiple accept="image/*">
        </div>
        <div class="mb-1 form-group">
    ...
    <div class="tab-pane fade" id="nav-en-update" role="tabpanel" aria-labelledby="nav-en-tab-update" tabindex="0">
        <div class="mb-1 form-group">
            ...
            <input type="text" placeholder="Tên dịch vụ" value="{{ $data->name_en }}" class="form-control"
                name="name_en">
        </div>
        <div class="mb-1 form-group">
            <label class="col-form-label">Mô tả</label>
            <textarea class="form-control" placeholder="Nội dung mô tả" rows="2" name="description_en">{{ $data->description_en }}</textarea>
        </div>
    </div>
    <div class="tab-pane fade" id="nav-ch-update" role="tabpanel" aria-labelledby="nav-ch-tab-update"
        ...
        <div class="mb-1 form-group">
            <label class="col-form-label">Tên</label>
            <input type="text" placeholder="Tên dịch vụ" value="{{ $data->name_ch }}" class="form-control"
                name="name_ch">
        </div>
        <div class="mb-1 form-group">
            <label class="col-form-label">Mô tả</label>
            <textarea class="form-control" placeholder="Nội dung mô tả" rows="2" name="description_ch">{{ $data->description_ch }}</textarea>
        </div>
    </div>
</div>
