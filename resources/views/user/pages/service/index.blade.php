...
@section('content')
    ...
    @include('user.pages.service.create')
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('user.service.update') }}" id="form-update" method="POST" enctype="multipart/form-data">
                @csrf
...
@push('js')
    <script>
        const routeList = "{{ route('user.service.list') }}";
        ...
        function confirmDelete(id) {
            deleteData(id, "{{ route('user.service.delete') }}");
        }
