...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5>Chi tiết thông tin liên hệ: #{{ $data->code }}</h5>
        <div class="btn-group" role="group">
            <a href="{{ route('user.contact.index') }}" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i> Quay lại
            </a>
            @if ($data->status != 'active')
                <a href="{{ route('user.contact.accept') }}?id={{ $data->id }}" class="btn btn-accept btn-success">
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <ul class="list-group">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - Nội dung:
                    <span class="text-end" style="max-width: 80%">{{ $data->comment }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - Thời gian:
                    <span>
