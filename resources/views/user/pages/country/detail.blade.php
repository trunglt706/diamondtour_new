...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h6 class="hide-mobile">Quốc gia: #{{ $data->id }}</h6>
        <div class="btn-group" role="group">
            <a href="{{ route('user.country.index') }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <ul class="list-group">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - SL khu vực:
                    <span>{{ $data->provinces_count }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - Thời gian tạo:
                    <span>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('user.country.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body px-4 py-1 content-update">
                        @include('user.pages.country.show')
                    </div>
