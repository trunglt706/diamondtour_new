<div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('user.library.insert') }}" id="form-create" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Tạo mới thư viện</h1>
                    <span>
                        <small class="pe-2">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-en" role="tabpanel" aria-labelledby="nav-en-tab"
                            ...
                            <div class="mb-1 form-group">
                                ...
                                <input type="text" placeholder="Tên ảnh" class="form-control" name="name_en">
                            </div>
                        </div>
                        <div class="tab-pane fade" id="nav-ch" role="tabpanel" aria-labelledby="nav-ch-tab"
                            ...
                            <div class="mb-1 form-group">
                                <label class="col-form-label">Tên</label>
                                <input type="text" placeholder="Tên ảnh" class="form-control" name="name_ch">
                            </div>
                        </div>
                    </div>
                </div>
