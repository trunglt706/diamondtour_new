...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h6 class="hide-mobile">Câu hỏi: #{{ $data->code }}</h6>
        <div class="btn-group" role="group">
            <a href="{{ route('user.qa.index') }}" class="btn btn-secondary">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('user.qa.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
@push('js')
    ...
    <script>
        initSelect2('#editModal .filter-group_id', "-- Chọn --", 'qa_groups', '#editModal');
