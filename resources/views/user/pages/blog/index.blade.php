...
@section('content')
    ...
    @include('user.pages.blog.create')
@endsection
@push('js')
    <script>
        initSelect2('.filter-group_id', "-- Danh mục --", 'blog_groups');
