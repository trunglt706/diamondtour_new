...
@section('title', 'Cập nhật thông tin blog')
@push('css')
...
@section('content')
    ...
    <div id="editModal">
        <form id="form-update" action="{{ route('user.blog.update') }}" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id" value="{{ $data->id }}">
            @csrf
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="hide-mobile">Blog: #{{ $data->name }}</h6>
                    <div class="btn-group" role="group">
                        <a type="button" href="{{ route('user.blog.detail', ['id' => $data->id]) }}"
                            ...
                            <div class="my-3 d-flex justify-content-between">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" name="hot" value="1" type="checkbox"
                                        role="switch" id="switch_hot_update" {{ $data->hot ? 'checked' : '' }}>
                                    <label class="form-check-label" for="switch_hot_update">
                                        Đề tài nóng
                                    </label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" name="like_total"
                                        {{ $data->like_total > 0 ? 'checked' : '' }} value="1" type="checkbox"
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" name="tieu_diem"
                                        {{ $data->tieu_diem ? 'checked' : '' }} value="1" type="checkbox"
                                        role="switch" id="switch_tieu_diem_update">
                                    <label class="form-check-label" for="switch_tieu_diem_update">
