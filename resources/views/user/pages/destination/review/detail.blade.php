...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h6 class="hide-mobile">Chi tiết review: #{{ $data->code }}</h6>
        <div class="btn-group" role="group">
            <a href="{{ route('user.review.index') }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 d-flex">
            <ul class="list-group w-100 me-3">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - Vị trí:
                    <span>{{ $data->destination ? 'Điểm đến - ' . $data->destination->name : 'Trang chủ' }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - Trạng thái:
                    <span
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form action="{{ route('user.review.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body px-4 py-1 content-update">
                        @include('user.pages.destination.review.show')
                    </div>
