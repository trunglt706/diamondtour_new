    ...
    <div class="row">
        ...
        <div class="col-lg-{{ $data->type == 'national' ? '8' : '12' }} col-sm-12 mb-2 d-flex">
            ...
            <div class="hide-mobile">
                ...
                <hr>
                <img src="{{ asset('style/images/blogs/default.jpg') }}" data-src="{{ $data->image_description ? get_file($data->image_description) : asset('user/img/user/no-avatar.jpg') }}"
                    class="img-thumbnail w-100px" loading="lazy" alt="img">
                <hr>
                <img src="{{ asset('style/images/blogs/default.jpg') }}" data-src="{{ $data->image_content ? get_file($data->image_content) : asset('user/img/user/no-avatar.jpg') }}"
                    class="img-thumbnail w-100px" loading="lazy" alt="img">
            </div>
        </div>
    </div>
