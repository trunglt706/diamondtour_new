...
@section('title', 'Tạo mới điểm đến')
@push('css')
    <link href="{{ asset('user/plugins/tag-it/css/jquery.tagit.css') }}" rel="stylesheet" />
@endpush
@section('content')
    <div id="addModal">
        <form id="form-create" action="{{ route('user.destination.insert') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="hide-mobile">Tạo mới điểm đến</h6>
                    <div class="btn-group" role="group">
                        <a type="button" href="{{ route('user.destination.index') }}" class="btn btn-secondary">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1 div_province_id" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mb-1">
                                    ...
                                    <input type="text" class="form-control" name="address" placeholder="VD: Hà Nội">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1 div_tour_group">
                                    ...
                                    <select name="tour_group_ids[]" class="form-select filter-tour_group_id" multiple>
                        ...
                        <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab"
                            ...
                            <div class="form-group mb-1">
                                ...
                                <textarea name="tien_ich" rows="3" class="form-control" id="tien_ich"></textarea>
                            </div>
                            <div class="form-group mb-1">
                                <label class="col-form-label">Kế hoạch du lịch và chi phí tham khảo</label>
                                <textarea name="plan" rows="3" class="form-control" id="plan"></textarea>
                            </div>
                            <div class="form-group mb-1">
                                <label class="col-form-label">Mọi người nói gì về chúng tôi</label>
                                <textarea name="talk" rows="3" class="form-control" id="talk"></textarea>
                            </div>
                        </div>
