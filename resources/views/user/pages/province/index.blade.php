...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="hide-mobile">Khu vực <span class="total-item">(0)</span></h5>
        <a href="{{ route('user.province.index') }}" class="btn btn-secondary">
            ...
            <table class="table table-bordered table-striped table-sm">
                <thead>
                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0 bg-light-primary">
                        ...
                        <th class="text-center w-200px">Quốc gia</th>
                    </tr>
                </thead>
    ...
    @include('user.pages.province.create')
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('user.province.update') }}" id="form-update" method="POST"
...
@push('js')
    <script>
        ...
        initSelect2('#addModal .country_id', "-- Chọn --", 'countries', '#addModal');
        const routeList = "{{ route('user.province.list') }}";
        ...
        function confirmDelete(id) {
            deleteData(id, "{{ route('user.province.delete') }}");
        }
        ...
        $(document).ready(function() {
            $(document).on("click", ".data-item", function(e) {
                ...
                $.get(url, function(data) {
                    ...
                    initSelect2('#editModal .country_id', "-- Chọn --", 'countries', '#editModal');
