...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="hide-mobile">Chi tiết thông tin đăng ký tour: #{{ $data->code }}</h5>
        <div class="btn-group" role="group">
            <a href="{{ route('user.register_tour.index') }}" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i> Quay lại
            </a>
            @if ($data->status != 'active')
                <a href="{{ route('user.register_tour.accept') }}?id={{ $data->id }}" class="btn btn-accept btn-success">
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12">
            <ul class="list-group">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - Số người lớn:
                    <span>{{ number_format($data->adults) }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - Số trẻ em:
                    <span>{{ number_format($data->children) }}</span>
                </li>
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    - Thời gian:
                    <span>
