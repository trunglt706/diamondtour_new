...
@section('content')
    <div id="addModal">
        <form id="form-create" action="{{ route('user.tour.insert') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="hide-mobile">Tạo mới tour</h6>
                    <div class="btn-group" role="group">
                        <a type="button" href="{{ route('user.tour.index') }}" class="btn btn-secondary">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-1">
                                    ...
                                    <input type="number" class="form-control" placeholder="VD: 2000000" name="price"
                                        min="0">
                                </div>
                                <div class="col-md-3 mb-1">
                                    <label class="col-form-label">Thời gian</label>
                                    <input type="text" class="form-control" name="duration" placeholder="VD: 2N1Đ">
                                </div>
                                <div class="col-md-3 mb-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="design" checked
                                                id="designinlineRadio0" value="0">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="bundle" checked
                                                id="bundleinlineRadio1" value="1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="VD: Tối thiểu 2"
                                            name="guest">
                                    </div>
                                </div>
                                <div class="col-md-4 mb-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            placeholder="VD: Tiếng Việt, tiếng Anh" name="language">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab"
                            ...
                            <div class="form-group mb-1">
                                ...
                                <textarea name="location_description" rows="3" class="form-control" id="location_description"></textarea>
                            </div>
                            <div class="form-group mb-1">
                                <label class="col-form-label">Bao gồm</label>
                                <textarea name="include" rows="3" class="form-control" id="include"></textarea>
                            </div>
                            <div class="form-group mb-1">
                                <label class="col-form-label">Không bao gồm</label>
                                <textarea name="exclude" rows="3" class="form-control" id="exclude"></textarea>
                            </div>
                            <div class="form-group mb-1">
                                <label class="col-form-label">Quy định</label>
                                <textarea name="term" rows="3" class="form-control" id="term"></textarea>
                            </div>
                            <div class="form-group mb-1">
                                <label class="col-form-label">Lưu ý</label>
                                <textarea name="notice" rows="3" class="form-control" id="note"></textarea>
                            </div>
                        </div>
