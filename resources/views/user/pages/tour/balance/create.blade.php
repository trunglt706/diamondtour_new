<div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('user.tour_balance.insert') }}" id="form-create" method="POST"
            enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Tạo mới ngân sách</h1>
                    <span>
                        <small class="pe-2">
                ...
                <div class="modal-body px-4 py-1">
                    ...
                    <div class="row">
                        <div class="mb-1 form-group">
                            ...
                            <input type="number" min="0" placeholder="VD: 0" class="form-control" required
                                name="from">
                        </div>
                        <div class="mb-1 form-group">
                            <label class="col-form-label">Kết thúc <span class="text-danger fw-900">*</span></label>
                            <input type="number" min="0" placeholder="VD: 1000000" class="form-control" required
                                name="to">
                        </div>
                    </div>
                    <div class="my-3">
