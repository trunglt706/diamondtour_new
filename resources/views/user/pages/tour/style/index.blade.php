...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="hide-mobile">Phong cách <span class="total-item">(0)</span></h5>
        <div class="btn-group hide-mobile">
            ...
            <a href="{{ route('user.tour_style.index') }}" class="btn btn-primary me-1">
                Phong cách
            </a>
    ...
    @include('user.pages.tour.style.create')
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('user.tour_style.update') }}" id="form-update" method="POST"
...
@push('js')
    <script>
        const routeList = "{{ route('user.tour_style.list') }}";
        ...
        function confirmDelete(id) {
            deleteData(id, "{{ route('user.tour_style.delete') }}");
        }
