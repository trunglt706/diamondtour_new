<div class="modal fade" id="addModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('user.schedule.insert') }}" id="form-create" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="tour_id" value="{{ $data['tour']->id }}">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5">Tạo mới lịch trình</h1>
                    <span>
                        <small class="pe-2">
                ...
                <div class="modal-body px-4 py-1">
                    <div class="mb-1 form-group">
                        ...
                        <input type="text" placeholder="Tên lịch trình" class="form-control" required name="name">
                    </div>
