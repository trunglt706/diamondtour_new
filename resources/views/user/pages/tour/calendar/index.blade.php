...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="hide-mobile">Lịch khởi hành <span class="total-item">(0)</span></h5>
        <div class="btn-group hide-mobile">
            ...
            <a href="{{ route('user.tour_calendar.index') }}" class="btn btn-primary me-1">
                Lịch khởi hành
            </a>
        </div>
    </div>
            ...
            <div class="card-header">
                ...
                <div class="d-flex justify-content-end hide-mobile">
                    <div class="me-1 w-300px">
                        <select name="tour_id" class="form-select filter-tour_id form-filter">
            ...
            <table class="table table-bordered table-striped table-sm">
                <thead>
                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0 bg-light-primary">
                        ...
                        <th class="text-center w-150px hide-mobile">Bắt đầu</th>
                        {{-- <th class="text-center w-150px hide-mobile">Kết thúc</th> --}}
                        {{-- <th class="text-center w-150px hide-mobile">Giá</th> --}}
                        <th class="text-center w-150px hide-mobile">Còn trống</th>
    ...
    @include('user.pages.tour.calendar.create')
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('user.tour_calendar.update') }}" id="form-update" method="POST"
...
@push('js')
    <script>
        const routeList = "{{ route('user.tour_calendar.list') }}";
        initSelect2('.filter-tour_id', "-- Tour --", 'tours');
        initSelect2('#addModal .tour_id', "-- Chọn --", 'tours', '#addModal');
        ...
        function confirmDelete(id) {
            deleteData(id, "{{ route('user.tour_calendar.delete') }}");
        }
