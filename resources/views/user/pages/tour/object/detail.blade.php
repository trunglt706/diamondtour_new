...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h6 class="hide-mobile">Đối tượng: #{{ $data->id }}</h6>
        <div class="btn-group" role="group">
            <a href="{{ route('user.tour_object.index') }}" class="btn btn-secondary">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('user.tour_object.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body px-4 py-1 content-update">
                        @include('user.pages.tour.object.show')
                    </div>
