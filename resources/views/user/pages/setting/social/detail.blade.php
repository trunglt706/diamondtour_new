...
@section('title', 'Chi tiết social')
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h6 class="hide-mobile">Menu: #{{ $data->name }}</h6>
        <div class="btn-group" role="group">
            <a href="{{ route('user.social.index') }}" class="btn btn-secondary">
    ...
    <div class="row">
        <div class="col-lg-12 col-sm-12 d-flex">
            ...
            <div class="hide-mobile">
                <img src="{{ asset('style/images/blogs/default.jpg') }}" data-src="{{ $data->icon ? get_file($data->icon) : asset('user/img/user/no-avatar.jpg') }}"
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('user.social.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body px-4 py-1 content-update">
                        @include('user.pages.setting.social.show')
                    </div>
