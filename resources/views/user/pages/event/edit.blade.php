...
@section('title', 'Cập nhật thông tin sự kiện')
@section('content')
    <div class="mb-3">
        Xem bài viết công khai tại
        <a target="_blank" href="{{ route('demo.event.detail', ['slug' => $data->slug]) }}" class="text-decoration-none">
            tại đây
        </a>
    </div>
    <div id="editModal">
        <form id="form-update" action="{{ route('user.event.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group" role="group">
                        <a type="button" href="{{ route('user.event.detail', ['id' => $data->id]) }}"
                        ...
                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab"
                            ...
                            <div class="form-group mb-1">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" {{ $data->home ? 'checked' : '' }}
                                        name="home" value="1" id="flexCheckDefault">
