...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5 class="hide-mobile">Danh sách sự kiện <span class="total-item">(0)</span></h5>
    </div>
            ...
            <div class="card-header">
                ...
                <div class="d-flex justify-content-end hide-mobile">
                    ...
                    <div class="btn-group" role="group">
                        ...
                        <a href="{{ route('user.event.create') }}" type="button" class="btn btn-primary">
...
@push('js')
    <script>
        const routeList = "{{ route('user.event.list') }}";
        ...
        function confirmDelete(id) {
            deleteData(id, "{{ route('user.event.delete') }}");
        }
    </script>
@endpush
