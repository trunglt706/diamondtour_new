jQuery(function() {
    ...
    jQuery(function() {
        ...
        jQuery('.wsmenu > .wsmenu-list > li')['has']('.sub-menu')['prepend']('<span class="wsmenu-click"><i class="wsmenu-arrow fas fa-angle-down"></i></span>');
        jQuery('.wsmenu > .wsmenu-list > li')['has']('.wsmegamenu')['prepend']('<span class="wsmenu-click"><i class="wsmenu-arrow fas fa-angle-down"></i></span>');
        jQuery('.wsmenu > .wsmenu-list > li .wsmegamenu ul li')['has']('.wsmegamenu')['prepend']('<span class="wsmenu-click"><i class="wsmenu-arrow fas fa-angle-down"></i></span>');
        ...
        jQuery('.wsmenu > .wsmenu-list > li .wsmegamenu ul.link-list .wsmegamenu-sub > li')['has']('.wsmegamenu-sub-sub')['prepend']('<span class="wsmenu-click03"><i class="wsmenu-arrow fas fa-angle-down"></i></span>');
